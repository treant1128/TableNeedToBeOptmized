...
public class OPMLParser {
	...
	public static List<com.wukong.snatch.pojo.Opml> getOPMLList(String urlPath){
		...
		Outline outlineParent=(Outline) feed.getOutlines().get(0);
		String opmlHeadTitle=feed.getTitle();
		String opmlBodyTitle=outlineParent.getTitle();
		String opmlBodyText=outlineParent.getText();
		List<Outline> outlines=outlineParent.getChildren();
		...
		for(Outline o:outlines){
			...
			opml.setOpmlHeadTitle(opmlHeadTitle);
			opml.setOpmlBodyTitle(opmlBodyTitle);
			opml.setOpmlBodyText(opmlBodyText);
			opml.setOpmlOutlineText(o.getText());
			opml.setOpmlOutlineTitle(o.getTitle());
			opml.setOpmlOutlineType(o.getType());
